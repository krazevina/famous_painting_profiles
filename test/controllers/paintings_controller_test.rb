...
class PaintingsControllerTest < ActionController::TestCase
  ...
  test "should create painting" do
    assert_difference('Painting.count') do
      post :create, painting: { artist: @painting.artist, body: @painting.body, genre: @painting.genre, image: @painting.image, location: @painting.location, material: @painting.material, title: @painting.title, year: @painting.year }
    end
  ...
  test "should update painting" do
    patch :update, id: @painting, painting: { artist: @painting.artist, body: @painting.body, genre: @painting.genre, image: @painting.image, location: @painting.location, material: @painting.material, title: @painting.title, year: @painting.year }
    assert_redirected_to painting_path(assigns(:painting))
  end
